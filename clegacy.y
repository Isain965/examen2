...
c_legacy:
	...
	c_legacy KEYWORD IDENTIFIER OPERATOR {printf("Bison found a new mehod:  %s\n", $3);}
	| c_legacy KEYWORD IDENTIFIER {printf("Bison found a new variable declaration: %s type %s\n", $3, $2);}
