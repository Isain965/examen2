...
c_legacy:
	...
	c_legacy IDENTIFIER OPERATOR IDENTIFIER OPERATOR IDENTIFIER {printf("Bison found a AssingInstr: %s %s %s\n", $4, $5, $6);}
	| c_legacy IDENTIFIER OPERATOR INT {printf("Bison encontro asignacion de variable: %s = %d\n", $2, $3);}
	| c_legacy IDENTIFIER OPERATOR BINARY {printf("Bison encontro asignacion de variable: %s = %s\n", $2, $3);}
	...
	| IDENTIFIER OPERATOR IDENTIFIER OPERATOR IDENTIFIER {printf("Bison found a AssingInstr: %s %s %s\n", $3, $4, $5);}
	| IDENTIFIER OPERATOR INT {printf("Bison encontro asignacion de variable: %s = %d\n", $1, $2);}
	| IDENTIFIER OPERATOR BINARY {printf("Bison encontro asignacion de variable: %s = %s\n", $1, $2);}
