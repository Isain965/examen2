...
c_legacy:
	...
	| c_legacy IDENTIFIER OPERATOR BINARY {printf("Bison encontro asignacion de variable: %s = %d\n", $2, $3);}
	...
	| IDENTIFIER OPERATOR BINARY {printf("Bison encontro asignacion de variable: %s = %d\n", $1, $2);}
