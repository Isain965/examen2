...
c_legacy:
	...
	| IDENTIFIER OPERATOR INT printf{("Bison encontro asignacion de variable: %s = %d", $2, $3)}
	| IDENTIFIER OPERATOR BINARY printf{("Bison encontro asignacion de variable: %s = %d", $2, $3)}
